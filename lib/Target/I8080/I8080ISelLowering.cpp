//===-- I8080ISelLowering.cpp - I8080 DAG Lowering Implementation -------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that I8080 uses to lower LLVM code into a
// selection DAG.
//
//===----------------------------------------------------------------------===//
...
bool I8080::isCalleePop(CallingConv::ID CallingConv,
...
I8080TargetLowering::I8080TargetLowering(const I8080TargetMachine &TM,
                                     const I8080Subtarget &STI)
  : TargetLowering(TM), Subtarget(STI) {
  //bool HasEI8080Ops = Subtarget.hasEI8080Ops(), Is24Bit = Subtarget.is24Bit();
  MVT PtrVT = MVT::getIntegerVT(8 * TM.getPointerSize(0));

  setSchedulingPreference(Sched::RegPressure);

  // Set up the register classes.
  addRegisterClass(MVT::i8, &I8080::RR8RegClass);
  addRegisterClass(MVT::i16, &I8080::R16RegClass);
  //if (Is24Bit)
  //  addRegisterClass(MVT::i24, &I8080::R24RegClass);
  ...
  setStackPointerRegisterToSaveRestore(I8080::SPS);
  ...
  // old: setLibcallCallingConv(RTLIB::ZEXT_I16_I24, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::SEXT_I16_I24, "_stoi");
  // old: setLibcallCallingConv(RTLIB::SEXT_I16_I24, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::SEXT_I24_I32, "_itol");
  // old: setLibcallCallingConv(RTLIB::SEXT_I24_I32, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::NOT_I16, "_snot");
  //setLibcallCallingConv(RTLIB::NOT_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::NOT_I24, "_inot");
  // old: setLibcallCallingConv(RTLIB::NOT_I24, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::NOT_I32, "_lnot");
  //setLibcallCallingConv(RTLIB::NOT_I32, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::AND_I16, "_sand");
  //setLibcallCallingConv(RTLIB::AND_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::AND_I24, "_iand");
  // old: setLibcallCallingConv(RTLIB::AND_I24, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::AND_I32, "_land");
  //setLibcallCallingConv(RTLIB::AND_I32, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::OR_I16, "_sor");
  //setLibcallCallingConv(RTLIB::OR_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::OR_I24, "_ior");
  // old: setLibcallCallingConv(RTLIB::OR_I24, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::OR_I32, "_lor");
  //setLibcallCallingConv(RTLIB::OR_I32, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::XOR_I16, "_sxor");
  //setLibcallCallingConv(RTLIB::XOR_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::XOR_I24, "_ixor");
  // old: setLibcallCallingConv(RTLIB::XOR_I24, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::XOR_I32, "_lxor");
  //setLibcallCallingConv(RTLIB::XOR_I32, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::SHL_I8, "_bshl");
  //setLibcallCallingConv(RTLIB::SHL_I8, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SHL_I16, "_sshl");
  setLibcallCallingConv(RTLIB::SHL_I16, CallingConv::I8080_LibCall_C);
  //setLibcallName(RTLIB::SHL_I16_I8, "_sshl_b");
  //setLibcallCallingConv(RTLIB::SHL_I16_I8, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::SHL_I24, "_ishl");
  // old: setLibcallCallingConv(RTLIB::SHL_I24, CallingConv::I8080_LibCall_C);
  // old: setLibcallName(RTLIB::SHL_I24_I8, "_ishl_b");
  // old: setLibcallCallingConv(RTLIB::SHL_I24_I8, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SHL_I32, "_lshl");
  setLibcallCallingConv(RTLIB::SHL_I32, CallingConv::I8080_LibCall_L);
  //setLibcallName(RTLIB::SRA_I8, "_bshrs");
  //setLibcallCallingConv(RTLIB::SRA_I8, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SRA_I16, "_sshrs");
  setLibcallCallingConv(RTLIB::SRA_I16, CallingConv::I8080_LibCall_C);
  //setLibcallName(RTLIB::SRA_I16_I8, "_sshrs_b");
  //setLibcallCallingConv(RTLIB::SRA_I16_I8, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::SRA_I24, "_ishrs");
  // old: setLibcallCallingConv(RTLIB::SRA_I24, CallingConv::I8080_LibCall_C);
  // old: setLibcallName(RTLIB::SRA_I24_I8, "_ishrs_b");
  // old: setLibcallCallingConv(RTLIB::SRA_I24_I8, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SRA_I32, "_lshrs");
  setLibcallCallingConv(RTLIB::SRA_I32, CallingConv::I8080_LibCall_L);
  //setLibcallName(RTLIB::SRL_I8, "_bshl");
  //setLibcallCallingConv(RTLIB::SRL_I8, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SRL_I16, "_sshru");
  setLibcallCallingConv(RTLIB::SRL_I16, CallingConv::I8080_LibCall_C);
  //setLibcallName(RTLIB::SRL_I16_I8, "_sshru_b");
  //setLibcallCallingConv(RTLIB::SRL_I16_I8, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::SRL_I24, "_ishru");
  // old: setLibcallCallingConv(RTLIB::SRL_I24, CallingConv::I8080_LibCall_C);
  // old: setLibcallName(RTLIB::SRL_I24_I8, "_ishru_b");
  // old: setLibcallCallingConv(RTLIB::SRL_I24_I8, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SRL_I32, "_lshru");
  setLibcallCallingConv(RTLIB::SRL_I32, CallingConv::I8080_LibCall_L);
  //setLibcallName(RTLIB::CMP_I32, "_lcmpu");
  //setLibcallCallingConv(RTLIB::CMP_I32, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::CMP_I16_0, "_scmpzero");
  //setLibcallCallingConv(RTLIB::CMP_I16_0, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::CMP_I24_0, "_icmpzero");
  // old: setLibcallCallingConv(RTLIB::CMP_I24_0, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::CMP_I32_0, "_lcmpzero");
  //setLibcallCallingConv(RTLIB::CMP_I32_0, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::SCMP, "_setflag");
  //setLibcallCallingConv(RTLIB::SCMP, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::NEG_I16, "_sneg");
  //setLibcallCallingConv(RTLIB::NEG_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::NEG_I24, "_ineg");
  // old: setLibcallCallingConv(RTLIB::NEG_I24, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::NEG_I32, "_lneg");
  setLibcallCallingConv(RTLIB::NEG_I32, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::ADD_I32, "_ladd");
  //setLibcallCallingConv(RTLIB::ADD_I32, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::ADD_I32_I8, "_ladd_b");
  //setLibcallCallingConv(RTLIB::ADD_I32_I8, CallingConv::I8080_LibCall);
  //setLibcallName(RTLIB::SUB_I32, "_lsub");
  //setLibcallCallingConv(RTLIB::SUB_I32, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::MUL_I8, "_bmulu");
  setLibcallCallingConv(RTLIB::MUL_I8, CallingConv::I8080_LibCall_BC);
  setLibcallName(RTLIB::MUL_I16, "_smulu");
  setLibcallCallingConv(RTLIB::MUL_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::MUL_I24, "_imulu");
  // old: setLibcallCallingConv(RTLIB::MUL_I24, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::MUL_I24_I8, "_imul_b");
  // old: setLibcallCallingConv(RTLIB::MUL_I24_I8, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::MUL_I32, "_lmulu");
  setLibcallCallingConv(RTLIB::MUL_I32, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SDIV_I8, "_bdivs");
  setLibcallCallingConv(RTLIB::SDIV_I8, CallingConv::I8080_LibCall_BC);
  setLibcallName(RTLIB::SDIV_I16, "_sdivs");
  setLibcallCallingConv(RTLIB::SDIV_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::SDIV_I24, "_idivs");
  // old: setLibcallCallingConv(RTLIB::SDIV_I24, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SDIV_I32, "_ldivs");
  setLibcallCallingConv(RTLIB::SDIV_I32, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::UDIV_I8, "_bdivu");
  setLibcallCallingConv(RTLIB::UDIV_I8, CallingConv::I8080_LibCall_BC);
  setLibcallName(RTLIB::UDIV_I16, "_sdivu");
  setLibcallCallingConv(RTLIB::UDIV_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::UDIV_I24, "_idivu");
  // old: setLibcallCallingConv(RTLIB::UDIV_I24, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::UDIV_I32, "_ldivu");
  setLibcallCallingConv(RTLIB::UDIV_I32, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SREM_I8, "_brems");
  setLibcallCallingConv(RTLIB::SREM_I8, CallingConv::I8080_LibCall_AC);
  setLibcallName(RTLIB::SREM_I16, "_srems");
  setLibcallCallingConv(RTLIB::SREM_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::SREM_I24, "_irems");
  // old: setLibcallCallingConv(RTLIB::SREM_I24, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::SREM_I32, "_lrems");
  setLibcallCallingConv(RTLIB::SREM_I32, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::UREM_I8, "_bremu");
  setLibcallCallingConv(RTLIB::UREM_I8, CallingConv::I8080_LibCall_AC);
  setLibcallName(RTLIB::UREM_I16, "_sremu");
  setLibcallCallingConv(RTLIB::UREM_I16, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::UREM_I24, "_iremu");
  // old: setLibcallCallingConv(RTLIB::UREM_I24, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::UREM_I32, "_lremu");
  setLibcallCallingConv(RTLIB::UREM_I32, CallingConv::I8080_LibCall);
  // old: setLibcallName(RTLIB::UDIVREM_I24, "_idvrmu");
  // old: setLibcallCallingConv(RTLIB::UDIVREM_I24, CallingConv::I8080_LibCall);
  setLibcallName(RTLIB::UDIVREM_I32, "_ldvrmu");
  setLibcallCallingConv(RTLIB::UDIVREM_I32, CallingConv::I8080_LibCall);
  setLibcallCallingConv(RTLIB::ADD_F32, CallingConv::I8080_LibCall_L);
}

// SelectionDAG Helpers

SDValue I8080TargetLowering::EmitOffset(int64_t Amount, const SDLoc &DL,
                                      SDValue Op, SelectionDAG &DAG) const {
  EVT VT = Op.getValueType();
  return DAG.getNode(ISD::ADD, DL, VT, Op, DAG.getConstant(Amount, DL, VT));
}

SDValue I8080TargetLowering::EmitNegate(const SDLoc &DL, SDValue Op,
                                      SelectionDAG &DAG) const {
  EVT VT = Op.getValueType();
  return DAG.getNode(ISD::SUB, DL, VT, DAG.getConstant(0, DL, VT), Op);
}

SDValue I8080TargetLowering::EmitFlipSign(const SDLoc &DL, SDValue Op,
                                        SelectionDAG &DAG) const {
  EVT VT = Op.getValueType();
...
SDValue I8080TargetLowering::EmitPair(const SDLoc &DL, SDValue Hi, SDValue Lo,
                                    SelectionDAG &DAG) const {
  assert(Hi.getValueType() == MVT::i8 && Lo.getValueType() == MVT::i8 &&
         "Can only emit a pair of i8 to i16");
  SDValue Ops[] = {
    DAG.getTargetConstant(I8080::GR16RegClassID, DL, MVT::i32),
    Hi, DAG.getTargetConstant(I8080::sub_high, DL, MVT::i32),
    Lo, DAG.getTargetConstant(I8080::sub_low, DL, MVT::i32),
  };
  SDNode *Res = DAG.getMachineNode(TargetOpcode::REG_SEQUENCE, DL, MVT::i16, Ops);
  return SDValue(Res, 0);
}

SDValue I8080TargetLowering::EmitLow(SDValue Op, SelectionDAG &DAG) const {
  return DAG.getNode(ISD::TRUNCATE, SDLoc(Op), MVT::i8, Op);
}

SDValue I8080TargetLowering::EmitHigh(SDValue Op, SelectionDAG &DAG) const {
  SDLoc DL(Op);
  return EmitLow(DAG.getNode(ISD::SRL, DL, Op.getValueType(), Op,
                             DAG.getConstant(8, DL, MVT::i8)), DAG);
}

SDValue I8080TargetLowering::EmitSignToCarry(SDValue Op,
                                           SelectionDAG &DAG) const {
  SDLoc DL(Op);
  EVT VT = Op.getValueType();
#if 0
  if (VT == MVT::i24) {
    if (Op.hasOneUse() && ISD::isNormalLoad(Op.getNode())) {
      ...
      return DAG.getNode(I8080ISD::ADD, DL, DAG.getVTList(VT, MVT::i8), Op, Op)
             .getValue(1);
  } else
#endif // 0
    if (VT == MVT::i16) {
      Op = DAG.getTargetExtractSubreg(I8080::sub_high, DL, MVT::i8, Op);
    }
  assert(Op.getValueType() == MVT::i8 && "Unexpected type!");
  return DAG.getNode(I8080ISD::SLA, DL, DAG.getVTList(MVT::i8, MVT::i8), Op)
         .getValue(1);
}

// Legalize Types Helpers

void I8080TargetLowering::ReplaceNodeResults(SDNode *N,
...
SDValue I8080TargetLowering::LowerAddSub(SDValue Op, SelectionDAG &DAG) const {
  SDLoc DL(Op);
...
SDValue I8080TargetLowering::LowerBitwise(SDValue Op, SelectionDAG &DAG) const {
  SDLoc DL(Op);
  unsigned Opc = Op.getOpcode();
  ...
  if (((Known.Zero | Known.One) & 0x00FF00) != 0x00FF00) {
    SDValue LHSHi = DAG.getTargetExtractSubreg(I8080::sub_high, DL, MVT::i8, LHS);
    SDValue RHSHi = DAG.getTargetExtractSubreg(I8080::sub_high, DL, MVT::i8, RHS);
    ResHi = DAG.getNode(Opc, DL, MVT::i8, LHSHi, RHSHi);
    Known.One &= ~0x00FF00;
  }
  if (((Known.Zero | Known.One) & 0x0000FF) != 0x0000FF) {
    SDValue LHSLo = DAG.getTargetExtractSubreg(I8080::sub_low, DL, MVT::i8, LHS);
    SDValue RHSLo = DAG.getTargetExtractSubreg(I8080::sub_low, DL, MVT::i8, RHS);
  ...
  if (ResHi) {
    Res = DAG.getTargetInsertSubreg(I8080::sub_high, DL, VT, Res, ResHi);
  }
  if (ResLo) {
    Res = DAG.getTargetInsertSubreg(I8080::sub_low,  DL, VT, Res, ResLo);
  }
  return Res;
}

SDValue I8080TargetLowering::LowerShift(SDValue Op, SelectionDAG &DAG) const {
  SDLoc DL(Op);
  unsigned Opc = Op.getOpcode();
  ...
  if (ConstantSDNode *Shift = dyn_cast<ConstantSDNode>(Op.getOperand(1))) {
    ...
    if (Opc == ISD::SRA && Amt == VT.getSizeInBits() - 1) {
      return DAG.getNode(I8080ISD::SEXT, DL, VT, EmitSignToCarry(Val, DAG));
    }
    ...
    case 8:
      ...
      case ISD::SHL: Opc = I8080ISD::SLA; break;
      case ISD::SRA: Opc = I8080ISD::SRA; break;
      case ISD::SRL: Opc = I8080ISD::SRL; break;
      case ISD::ROTL: Opc = I8080ISD::RLC; break;
      case ISD::ROTR: Opc = I8080ISD::RRC; break;
      }
      while (Amt--) {
    ...
    case 16:
      if (Amt >= 8) {
        Val = DAG.getTargetExtractSubreg(
                Opc == ISD::SHL ? I8080::sub_low : I8080::sub_high, DL, MVT::i8, Val);
      ...
      if (Opc != ISD::SHL && (!OptSize || Amt == 1)) {
        unsigned Opc0 = Opc == ISD::SRA ? I8080ISD::SRA : I8080ISD::SRL;
        SDValue Val0 = DAG.getTargetExtractSubreg(I8080::sub_high, DL,
                                                  MVT::i8, Val);
        unsigned Opc1 = I8080ISD::RR;
        SDValue Val1 = DAG.getTargetExtractSubreg(I8080::sub_low, DL,
                                                  MVT::i8, Val);
        while (Amt--) {
    ...
    case 24:
      if (Opc == ISD::SHL) {
        ...
        while (Amt--)
          Val = DAG.getNode(I8080ISD::ADD, DL,
...
SDValue I8080TargetLowering::LowerAnyExtend(SDValue Op, SelectionDAG &DAG) const {
  ...
  return DAG.getTargetInsertSubreg(
           ValVT == MVT::i16 ? I8080::sub_short : I8080::sub_low, DL, VT,
           DAG.getUNDEF(VT), Val);
}

SDValue I8080TargetLowering::LowerZeroExtend(SDValue Op,
                                           SelectionDAG &DAG) const {
...
SDValue I8080TargetLowering::LowerSignExtend(SDValue Op,
                                           SelectionDAG &DAG) const {
  ...
  if (VT == MVT::i16) {
    ...
    return DAG.getTargetInsertSubreg(
             I8080::sub_high, DL, VT, DAG.getNode(ISD::ANY_EXTEND, DL, VT, Val),
             DAG.getNode(I8080ISD::SEXT, DL, ValVT, Sign));
  }
  //assert(VT == MVT::i24 && (ValVT == MVT::i16 || ValVT == MVT::i8) &&
  //       "Unexpected sign extend");
  return DAG.getTargetInsertSubreg(
           ValVT == MVT::i16 ? I8080::sub_short : I8080::sub_low, DL, VT,
           DAG.getNode(I8080ISD::SEXT, DL, VT, Sign), Val);
}

SDValue I8080TargetLowering::LowerMul(SDValue Op, SelectionDAG &DAG) const {
  ...
  SDValue Res = DAG.getZExtOrTrunc(
                  DAG.getNode(I8080ISD::MLT, DL, MVT::i16,
...
SDValue I8080TargetLowering::LowerGlobalAddress(GlobalAddressSDNode *Node,
                                              SelectionDAG &DAG) const {
  SDLoc DL(Node);
  auto PtrVT = getPointerTy(DAG.getDataLayout());
  SDValue Res = DAG.getTargetGlobalAddress(Node->getGlobal(), DL, PtrVT,
                                           Node->getOffset());
  return DAG.getNode(I8080ISD::Wrapper, DL, PtrVT, Res);
}

SDValue I8080TargetLowering::LowerExternalSymbol(ExternalSymbolSDNode *Node,
                                               SelectionDAG &DAG) const {
  SDLoc DL(Node);
  auto PtrVT = getPointerTy(DAG.getDataLayout());
...
SDValue I8080TargetLowering::LowerBlockAddress(BlockAddressSDNode *Node,
                                             SelectionDAG &DAG) const {
  SDLoc DL(Node);
  auto PtrVT = getPointerTy(DAG.getDataLayout());
...
SDValue I8080TargetLowering::LowerLoad(LoadSDNode *Node,
                                     SelectionDAG &DAG) const {
  SDLoc DL(Node);
  ...
  bool Split = I8080::splitReg(MMO->getSize(), MVT::i8, // MVT::i16,
                             RC, LoTy, LoIdx, HiTy, HiIdx, HiOff
                             /*Subtarget.hasEI8080Ops()*/);
...
SDValue I8080TargetLowering::LowerStore(StoreSDNode *Node,
                                      SelectionDAG &DAG) const {
  SDLoc DL(Node);
  SDValue Ch = Node->getChain();
  SDValue Ptr = Node->getBasePtr();
...
SDValue I8080TargetLowering::LowerVAStart(SDValue Op, SelectionDAG &DAG) const {
  MachineFunction &MF = DAG.getMachineFunction();
  I8080MachineFunctionInfo *FuncInfo = MF.getInfo<I8080MachineFunctionInfo>();
  SDLoc DL(Op);
...
SDValue I8080TargetLowering::LowerOperation(SDValue Op, SelectionDAG &DAG) const {
...
SDValue I8080TargetLowering::EmitCmp(SDValue LHS, SDValue RHS, SDValue &TargetCC,
  ...
  I8080::CondCode TCC = I8080::COND_INVALID;
  unsigned Opc = I8080ISD::SUB;
  switch (CC) {
  ...
  case I8080::COND_NC:
    ...
    if (VT != MVT::i8 && Const) {
      Opc = I8080ISD::ADD;
      TCC = I8080::GetOppositeBranchCondition(TCC);
      ConstVal = -ConstVal;
      if (ConstVal == SignVal) {
        RHS = LHS;
        Const = nullptr;
...
SDValue I8080TargetLowering::EmitExtractSubreg(unsigned Idx, const SDLoc &DL,
                                             SDValue Op,
                                             SelectionDAG &DAG) const {
...
SDValue I8080TargetLowering::EmitInsertSubreg(unsigned Idx, const SDLoc &DL,
                                            MVT VT, SDValue Op,
                                            SelectionDAG &DAG) const {
  const TargetRegisterInfo *TRI = Subtarget.getRegisterInfo();
...
SDValue I8080TargetLowering::LowerBR_CC(SDValue Op, SelectionDAG &DAG) const {
  ...
  return DAG.getNode(I8080ISD::BRCOND, DL, MVT::Other,
                     Chain, Dest, TargetCC, Flags);
}

SDValue I8080TargetLowering::LowerSETCC(SDValue Op, SelectionDAG &DAG) const {
  ...
  EVT VT = Op.getValueType();
  return DAG.getNode(I8080ISD::SELECT, DL, DAG.getVTList(VT, MVT::Glue),
                     DAG.getConstant(1, DL, VT), DAG.getConstant(0, DL, VT),
                     TargetCC, Flags);
}

SDValue I8080TargetLowering::LowerSELECT_CC(SDValue Op, SelectionDAG &DAG) const {
  SDValue LHS = Op.getOperand(0);
  SDValue RHS = Op.getOperand(1);
  ...
  return DAG.getNode(I8080ISD::SELECT, DL,
                     DAG.getVTList(Op.getValueType(), MVT::Glue), TV, FV,
                     TargetCC, Flag);
}

SDValue I8080TargetLowering::LowerLibCall(
...
bool I8080TargetLowering::isOffsetFoldingLegal(
...
bool I8080TargetLowering::isLegalAddressingMode(const DataLayout &DL,
...
bool I8080TargetLowering::isLegalICmpImmediate(int64_t Imm) const {
  return isInt<8>(Imm);
}
bool I8080TargetLowering::isLegalAddImmediate(int64_t Imm) const {
  return isInt<8>(Imm);
}

bool I8080TargetLowering::isTruncateFree(Type *Ty1, Type *Ty2) const {
  if (!Ty1->isIntegerTy() || !Ty2->isIntegerTy()) {
    return false;
  }
  return Ty1->getPrimitiveSizeInBits() > Ty2->getPrimitiveSizeInBits();
}
bool I8080TargetLowering::isTruncateFree(EVT VT1, EVT VT2) const {
...
#if 0
bool I8080TargetLowering::isZExtFree(Type *Ty1, Type *Ty2) const {
...
bool I8080TargetLowering::isZExtFree(EVT VT1, EVT VT2) const {
  // ez80 implicitly zero-extends 16-bit results in 24-bit registers.
  return VT1 == MVT::i16 && VT2 == MVT::i24 && Subtarget.is24Bit();
}

bool I8080TargetLowering::isNarrowingProfitable(EVT VT1, EVT VT2) const {
...
bool I8080TargetLowering::shouldConvertConstantLoadToIntImm(const APInt &Imm,
                                                          Type *Ty) const {
...
SDValue I8080TargetLowering::combineCopyFromReg(SDNode *N,
...
SDValue I8080TargetLowering::combineStore(StoreSDNode *N,
                                        DAGCombinerInfo &DCI) const {
  SelectionDAG &DAG = DCI.DAG;
  MachineFunction &MF = DAG.getMachineFunction();
  MachineFrameInfo &MFI = MF.getFrameInfo();
...
SDValue I8080TargetLowering::combineINSERT_SUBREG(SDNode *N,
                                                DAGCombinerInfo &DCI) const {
  return SDValue();
}

// This code is from DAGCombiner::visitADDC
SDValue I8080TargetLowering::combineADD(SDNode *N, DAGCombinerInfo &DCI) const {
  SelectionDAG &DAG = DCI.DAG;
...
SDValue I8080TargetLowering::combineSUB(SDNode *N, DAGCombinerInfo &DCI) const {
  SelectionDAG &DAG = DCI.DAG;
  EVT VT = N->getValueType(0);
  SDValue N0 = N->getOperand(0);
  SDValue N1 = N->getOperand(1);
...
static SDValue combineMul(SDNode *N, SelectionDAG &DAG,
  ...
  if (auto C1 = dyn_cast<ConstantSDNode>(N1)) {
    ...
    if (Odd) {
      Double = DAG.getNode(I8080ISD::ADD, DL, VT, Double, N0);
    }
    return Double;
  }
  return SDValue();
...
static SDValue implicitlyClearTop(SDValue &Op, SelectionDAG &DAG) {
  ...
  case ISD::ADD: NewOpc = I8080ISD::ADD; break;
  case ISD::SUB: NewOpc = I8080ISD::SUB; break;
  }
  ...
  return SDValue(DAG.getMachineNode(TargetOpcode::SUBREG_TO_REG, DL,
                                    ...
                                    DAG.getTargetConstant(I8080::sub_short,
                                                          DL, MVT::i32)), 0);
}
#endif // 0
...
static SDValue combineTruncate(SDNode *N, SelectionDAG &DAG) {
  ...
  if (VT == MVT::i8 && Val.hasOneUse())
    ...
    case ISD::SRA:
      ...
      break;
    case I8080ISD::SEXT:
      return DAG.getNode(I8080ISD::SEXT, DL, VT, Val.getOperand(0));
    }
  return SDValue();
}
...
static SDValue combineSub(SDNode *N, TargetLowering::DAGCombinerInfo &DCI) {
  ...
  if (Val0.use_empty())
    return DCI.CombineTo(N, Val0,
                         DAG.getNode(I8080ISD::CP, DL, N->getValueType(1),
...
static SDValue combineSExt(SDNode *N, SelectionDAG &DAG,
  ...
  //  return DAG.getNode(ISD::TRUNCATE, DL, VT,
  //                     DAG.getNode(I8080ISD::SEXT, DL, MVT::i24, N0));
  return SDValue();
}

SDValue I8080TargetLowering::PerformDAGCombine(SDNode *N,
                                             DAGCombinerInfo &DCI) const {
  SelectionDAG &DAG = DCI.DAG;
  ...
  case I8080ISD::SUB:      return combineSub(N, DCI);
  case I8080ISD::SEXT:     return combineSExt(N, DCI.DAG, Subtarget);
  }
//switch (N->getOpcode()) {
...
//case I8080ISD::ADD:                  return combineADD(N, DCI);
//case I8080ISD::SUB:                  return combineSUB(N, DCI);
//}
  return SDValue();
}
...
/// slower.
bool I8080TargetLowering::isTypeDesirableForOp(unsigned Opc, EVT VT) const {
  if (!isTypeLegal(VT)) {
    return false;
  }
#if 0
...
bool I8080TargetLowering::isDesirableToShrinkOp(unsigned Opc, EVT SrcVT,
                                              EVT DstVT) const {
  ...
  case ISD::SUBE:
    ...
    // $TODO: Are these for I8080 as well?
...
/// type by reference.
bool I8080TargetLowering::IsDesirableToPromoteOp(SDValue Op, EVT &PVT) const {
#if 0
...
MachineBasicBlock *
I8080TargetLowering::EmitInstrWithCustomInserter(MachineInstr &MI,
...
#if 1
void I8080TargetLowering::AdjustInstrPostInstrSelection(MachineInstr &MI,
                                                      SDNode *Node) const {
  switch (MI.getOpcode()) {
  default: llvm_unreachable("Unexpected instr type to insert");
  case I8080::ADJCALLSTACKUP16:
  //case I8080::ADJCALLSTACKUP24:
  case I8080::ADJCALLSTACKDOWN16:
    //case I8080::ADJCALLSTACKDOWN24:
    return AdjustAdjCallStack(MI);
  }
}

void I8080TargetLowering::AdjustAdjCallStack(MachineInstr &MI) const {
  //bool Is24Bit = MI.getOpcode() == I8080::ADJCALLSTACKUP24 ||
  //               MI.getOpcode() == I8080::ADJCALLSTACKDOWN24;
  assert((/*Is24Bit ||*/ MI.getOpcode() == I8080::ADJCALLSTACKUP16 ||
                         MI.getOpcode() == I8080::ADJCALLSTACKDOWN16) &&
         "Unexpected opcode");
  MachineRegisterInfo &MRI = MI.getParent()->getParent()->getRegInfo();
  unsigned Reg = MRI.createVirtualRegister(&I8080::AIR16RegClass);
...
MachineBasicBlock *
I8080TargetLowering::EmitLoweredSub(MachineInstr &MI,
                                  MachineBasicBlock *BB) const {
  //bool Is24Bit = MI.getOpcode() == I8080::SUB24ao;
  assert((/*Is24Bit ||*/ MI.getOpcode() == I8080::SUB16ao) && "Unexpected opcode");
  const TargetInstrInfo *TII = Subtarget.getInstrInfo();
  DebugLoc DL = MI.getDebugLoc();
  LLVM_DEBUG(BB->dump());
  BuildMI(*BB, MI, DL, TII->get(I8080::RCF));
  BuildMI(*BB, MI, DL, TII->get(I8080::SBC16ao))
...
MachineBasicBlock *
I8080TargetLowering::EmitLoweredCmp(MachineInstr &MI,
                                  MachineBasicBlock *BB) const {
  //bool Is24Bit = MI.getOpcode() == I8080::CP24ao;
  ...
  BuildMI(*BB, MI, DL, TII->get(I8080::SBC16ao))
  .addReg(MI.getOperand(0).getReg());
  BuildMI(*BB, MI, DL, TII->get(I8080::ADD16ao),
          I8080::HL).addReg(I8080::HL)
  .addReg(MI.getOperand(0).getReg());
  MI.eraseFromParent();
  LLVM_DEBUG(BB->dump());
  return BB;
...
MachineBasicBlock *
I8080TargetLowering::EmitLoweredCmp0(MachineInstr &MI,
                                   MachineBasicBlock *BB) const {
  //bool Is24Bit = MI.getOpcode() == I8080::CP24a0;
...
MachineBasicBlock *
I8080TargetLowering::EmitLoweredSelect(MachineInstr &MI,
                                     MachineBasicBlock *BB) const {
  const TargetInstrInfo *TII = Subtarget.getInstrInfo();
  DebugLoc DL = MI.getDebugLoc();
  ...
  BuildMI(BB, DL, TII->get(I8080::JQCC)).addMBB(copy1MBB)
  ...
  //  ...
  BB = copy1MBB;
  BuildMI(*BB, BB->begin(), DL, TII->get(I8080::PHI),
...
MachineBasicBlock *I8080TargetLowering::EmitLoweredSExt(
...
#include "I8080GenCallingConv.inc"

CCAssignFn *I8080TargetLowering::getCCAssignFn(CallingConv::ID CallConv) const {
  //bool Is24Bit = Subtarget.is24Bit();
  switch (CallConv) {
  ...
  case CallingConv::PreserveAll:
    ...
    //  return CC_EI8080_LC_AB;
    //case CallingConv::I8080_LibCall_AC:
    //  return CC_EI8080_LC_AC;
    //case CallingConv::I8080_LibCall_BC:
    //  return CC_EI8080_LC_BC;
    //case CallingConv::I8080_LibCall_C:
    //  return CC_EI8080_LC_C;
    //case CallingConv::I8080_LibCall_L:
    //  return CC_EI8080_LC_L;
  }
}
CCAssignFn *I8080TargetLowering::getRetCCAssignFn(CallingConv::ID CallConv)
const {
  //bool Is24Bit = Subtarget.is24Bit();
  switch (CallConv) {
  default: llvm_unreachable("Unsupported calling convention!");
  ...
  case CallingConv::I8080_LibCall_BC:
  case CallingConv::I8080_LibCall_C:
    return RetCC_I8080_C;
    //case CallingConv::I8080_LibCall_L:
    //  return RetCC_EI8080_LC_L;
  }
}

SDValue I8080TargetLowering::LowerCall(TargetLowering::CallLoweringInfo &CLI,
  ...
  for (unsigned I = ArgLocs.size(); I; --I) {
    ...
    unsigned Reg = VA.isRegLoc() ? VA.getLocReg() : I8080::NoRegister;
    ...
    if (OA.Flags.isSplitEnd() && !OA.Flags.isZExt() && !OA.Flags.isSExt()) {
      ...
      if (LocVT.getStoreSize() != RegBytes) {
        ...
        case 1: Idx = I8080::sub_low;   break;
        case 2: Idx = I8080::sub_short; break;
        }
    ...
    if (VA.isRegLoc()) {
      ...
      Chain = DAG.getMemIntrinsicNode(
                I8080ISD::PUSH, DL, DAG.getVTList(MVT::Other),
  ...
  if (IsTailCall) {
    ...
    return DAG.getNode(I8080ISD::TC_RETURN, DL, NodeTys, Ops);
  }

  // Returns a chain and a flag for retval copy to use.
  Chain = DAG.getNode(I8080ISD::CALL, DL, NodeTys, Ops);
  InFlag = Chain.getValue(1);
...
bool I8080TargetLowering::IsEligibleForTailCallOptimization(
...
llvm::EVT llvm::I8080TargetLowering::getTypeForExtReturn(
  LLVMContext &Context, EVT VT, ISD::NodeType ExtendKind) const {
  return getRegisterType(Context, MVT::i8);
}

SDValue I8080TargetLowering::LowerReturn(SDValue Chain,
  ...
  unsigned Opc = I8080ISD::RET_FLAG;
  if (F.hasFnAttribute("interrupt"))
    Opc = F.getFnAttribute("interrupt").getValueAsString() == "NMI" ?
          I8080ISD::RETN_FLAG : I8080ISD::RETI_FLAG;
...
///
SDValue
I8080TargetLowering::LowerCallResult(SDValue Chain, SDValue InFlag,
                                   CallingConv::ID CallConv, bool IsVarArg,
...
SDValue
I8080TargetLowering::LowerMemArgument(SDValue Chain, CallingConv::ID CallConv,
                                    const SmallVectorImpl<ISD::InputArg> &Ins,
...
SDValue I8080TargetLowering::LowerFormalArguments(
  ...
  for (unsigned I = 0, InsIndex = 0, E = ArgLocs.size(); I != E;
    ...
    if (VA.isRegLoc()) {
      ...
      if (VA.needsCustom()) {
        ...
        if (RegVT == MVT::i8) {
          RC = &I8080::GR8RegClass;
        } else if (RegVT == MVT::i16)
          RC = &I8080::GR16RegClass;
#if 0
  ...
  if (I8080::isCalleePop(CallConv, /*Is64Bit,*/ isVarArg,
                       MF.getTarget().Options.GuaranteedTailCallOpt)) {
...
const char *I8080TargetLowering::getTargetNodeName(unsigned Opcode) const {
  switch ((I8080ISD::NodeType)Opcode) {
  case I8080ISD::FIRST_NUMBER: break;
  case I8080ISD::Wrapper:      return "I8080ISD::Wrapper";
  case I8080ISD::RLC:          return "I8080ISD::RLC";
  case I8080ISD::RRC:          return "I8080ISD::RRC";
  case I8080ISD::RL:           return "I8080ISD::RL";
  case I8080ISD::RR:           return "I8080ISD::RR";
  case I8080ISD::SLA:          return "I8080ISD::SLA";
  case I8080ISD::SRA:          return "I8080ISD::SRA";
  case I8080ISD::SRL:          return "I8080ISD::SRL";
  case I8080ISD::INC:          return "I8080ISD::INC";
  case I8080ISD::DEC:          return "I8080ISD::DEC";
  case I8080ISD::ADD:          return "I8080ISD::ADD";
  case I8080ISD::ADC:          return "I8080ISD::ADC";
  case I8080ISD::SUB:          return "I8080ISD::SUB";
  case I8080ISD::SBC:          return "I8080ISD::SBC";
  case I8080ISD::AND:          return "I8080ISD::AND";
  case I8080ISD::XOR:          return "I8080ISD::XOR";
  case I8080ISD::OR:           return "I8080ISD::OR";
  case I8080ISD::CP:           return "I8080ISD::CP";
  case I8080ISD::TST:          return "I8080ISD::TST";
  case I8080ISD::MLT:          return "I8080ISD::MLT";
  case I8080ISD::SEXT:         return "I8080ISD::SEXT";
  case I8080ISD::CALL:         return "I8080ISD::CALL";
  case I8080ISD::RET_FLAG:     return "I8080ISD::RET_FLAG";
  case I8080ISD::RETN_FLAG:    return "I8080ISD::RETN_FLAG";
  case I8080ISD::RETI_FLAG:    return "I8080ISD::RETI_FLAG";
  case I8080ISD::TC_RETURN:    return "I8080ISD::TC_RETURN";
  case I8080ISD::BRCOND:       return "I8080ISD::BRCOND";
  case I8080ISD::SELECT:       return "I8080ISD::SELECT";
  case I8080ISD::POP:          return "I8080ISD::POP";
  case I8080ISD::PUSH:         return "I8080ISD::PUSH";
  }
  return nullptr;
}

EVT I8080TargetLowering::getSetCCResultType(const DataLayout &DL,
                                          LLVMContext &Context,
                                          EVT VT) const {
  assert(!VT.isVector() && "No default SetCC type for vectors!");
  return MVT::i8;
}
MVT::SimpleValueType I8080TargetLowering::getCmpLibcallReturnType() const {
  return MVT::Other;
}
