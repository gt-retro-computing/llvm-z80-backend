//===-- I8080InstrInfo.h - I8080 Instruction Information ------------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_I8080_I8080INSTRINFO_H
#define LLVM_LIB_TARGET_I8080_I8080INSTRINFO_H
...
namespace I8080 {
// I8080 specific condition code. These correspond to I8080_*_COND in
// I8080InstrInfo.td. They must be kept in synch.
enum CondCode {
  COND_NZ = 0,
  COND_Z = 1,
  COND_NC = 2,
...
} // end namespace I8080II;

class I8080InstrInfo final : public I8080GenInstrInfo {
  I8080Subtarget &Subtarget;
  const I8080RegisterInfo RI;

  virtual void anchor();

public:
  explicit I8080InstrInfo(I8080Subtarget &STI);

  /// getRegisterInfo - TargetInstrInfo is a superset of MRegister info.  As
  /// such, whenever a client has an instance of instruction info, it should
  /// always be able to get register info as well (through this method).
  ///
  const I8080RegisterInfo &getRegisterInfo() const { return RI; }
