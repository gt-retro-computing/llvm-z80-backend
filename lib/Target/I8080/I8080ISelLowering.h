//===-- I8080ISelLowering.h - I8080 DAG Lowering Interface ----------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_I8080_I8080ISELLOWERING_H
#define LLVM_LIB_TARGET_I8080_I8080ISELLOWERING_H
...
enum NodeType : unsigned {
  ...
  /// This operation represents an abstract I8080 call instruction, which
  ...
  /// BRCOND - I8080 conditional branch.  The first operand is the chain, the
  /// second is the block to branch to if the condition is true, the third is
  /// the condition, and the fourth is the flag operand.
  BRCOND,

  /// SELECT - I8080 select - This selects between a true value and a false
...
//===----------------------------------------------------------------------===//
//  I8080 Implementation of the TargetLowering interface
class I8080TargetLowering final : public TargetLowering {
  /// Keep a reference to the I8080Subtarget around so that we can
  /// make the right decision when generating code for different targets.
  const I8080Subtarget &Subtarget;

public:
  explicit I8080TargetLowering(const I8080TargetMachine &TM,
