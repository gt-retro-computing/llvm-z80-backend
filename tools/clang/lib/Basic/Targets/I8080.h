//===--- I8080.h - Declare I8080 target feature support -------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares I8080 TargetInfo objects.
//
//===----------------------------------------------------------------------===//
...
class LLVM_LIBRARY_VISIBILITY I8080TargetInfoBase : public TargetInfo {
public:
  I8080TargetInfoBase(const llvm::Triple &Triple) : TargetInfo(Triple) {
    TLSSupported = false;
...
class LLVM_LIBRARY_VISIBILITY I8080TargetInfo : public I8080TargetInfoBase {
public:
  explicit I8080TargetInfo(const llvm::Triple &T) : I8080TargetInfoBase(T) {
